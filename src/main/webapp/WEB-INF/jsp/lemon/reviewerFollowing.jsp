...
<!--                             </p> -->
        ...
        <div class="reviewer-navi reviewer-navi--l">
            <ul class="reviewer-navi__list">
                ...
                <li id="reviewer-navi-follow" class="reviewer-navi__item reviewer-navi__item--follow  is-selected">
				...
				<div class="c-view-sort rvwr-view-sort">
					<ul class="c-view-sort__list js-sort-list">
						<li class="c-view-sort__item"><a
							...
							href="${contextRoot}/reviewerAll">別人點的看起來都比較好吃</a></li>
<!-- 						<li class="c-view-sort__item"><a -->
...
$('#followBtn').click(function(){
	...
	$.ajax({
		url:'http://localhost:8080/oldFoodMan/relationship/unfollowing/'+ memberId,
