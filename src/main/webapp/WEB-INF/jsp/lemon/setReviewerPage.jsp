...
// 						});
	...
	function oneclick (){
		...
		$("#intro").val("基本上，對維梅爾本人或者他的作品，後人所知的都不多。畫作署名「IVMeer」，但沒有日期。沒有人知道這幅畫作的代理權誰屬，甚至不知道作者有沒有交付過代理權給任何人。近年有專家指出此畫作可能是一幅「tronie」，即17世紀的荷蘭流行的頭像，而這種頭像嚴格而言算不上是一幅畫作。於1994年的修復後，畫作精密的顏色運用及畫中少女對其觀察者的親密目光更被專家所留意。無論如何，這一幅畫都不只是普通的肖像畫。畫家可能在嘗試捕捉這個女孩（身份不明，但一般相信是維梅爾的女兒瑪麗亞）對剛發現的某人回眸的樣子。");
