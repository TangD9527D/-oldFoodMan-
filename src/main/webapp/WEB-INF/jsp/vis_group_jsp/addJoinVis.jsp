...
<body>
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			...
			<div class="col-9">
				<div class="card">
					<div class="card-header text-white bg-dark ">加入揪團</div>
					<div class="card-body">
						<form:form class="form" action="${contextRoot}/addjoinvis"
...
<!-- 									<label for="inputEmail4">發起人</label> -->
									...
									<form:input  type="hidden" path="member_id" class="form-control" value="${ofmid}" />
